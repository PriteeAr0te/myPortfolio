...
const Contact = ({heroRef, skillsRef, projectsRef, experienceRef, educationRef, contactRef}) => {
    ...
    return (
        <div className='w-full bg-gradient-to-b from-indigo-950 to-slate-950 min-h-screen'>
            <h1 className='w-full text-center text-5xl font-bold text-slate-200 tracking-wide hover:tracking-wider'> Contact </h1>
            <div className='w-full text-center'>
                <p className='text-slate-400 text-xl mt-3 font-medium px-7 md:px-[15rem]'>Feel free to reach out to me for any questions or opportunities!</p>
            </div>
            <div className='flex justify-center flex-wrap my-3 p-[30px] md:p-[50px]'>
                <div className='bg-slate-950 w-[50%] h-[570px] rounded-xl m-3 p-3 md:px-5 transition duration-300 ease-in-out transform hover:shadow-lg hover:-translate-y-2 hover:transition-all hover:duration-200 overflow-hidden hover:shadow-opacity-100 hover:rounded-2xl border-fuchsia-400 border-2'>
                    <div className='flex'>
                        <h1 className='text-indigo-500 text-2xl font-bold py-3'> Email Me </h1>                    
                        </div>
                    <div>
                        <form ref={form} className="form mx-auto" onSubmit={sendEmail} >
                            ...
                            <div className="mb-1.5 md:px-5">
                                <textarea className="my-3 bg-slate-950 w-full h-auto text-slate-300 border-2 border-slate-400 px-2 py-2" placeholder="Enter Message" name="message" id="message" rows="3"></textarea>
                            </div>
