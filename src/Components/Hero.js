...
const Hero = () => {
  ...
  return (
    ...
    <div className=' md:flex md:justify-between text-white bg-gradient-to-b from-slate-950 to-indigo-950 p-8 min-h-screen'>
      <div className='p-[50px] md:p-[70px] md:py-[90px]'>
        ...
        <p className='font-bold text-3xl md:text-6xl text-white tracking-wider my-3'>I'm <span className='text-indigo-600'>Pritee </span>Arote</p>
        <p className=' text-white tracking-wider my-5'>
          <span className='font-semibold text:xl md:text-2xl'>I Am Into </span> 
          <span className='font-semibold text-xl md:text-3xl text-indigo-600 tracking-wider'>
          <TypeAnimation
      sequence={[
        ' MERN Development',
        1000, 
    ...
    />
       ...
       <a className='hover:bg-slate-950 rounded-2xl border-indigo-700 border-2 bg-indigo-800 text-indigo-100 hover:text-indigo-400 font-semibold p-3 px-7 cursor-pointer text-lg hover:text-[20px]' target="_blank" rel="noopener noreferrer" href='https://drive.google.com/file/d/1pR1tRdB1B3RSYAwU9cQfHQJ52vyvm8nL/view?usp=sharing"'> Check Resume</a>
       </div>
      </div>
