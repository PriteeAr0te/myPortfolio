...
//   document.body.addEventListener('click', handleOutsideClick)
  ...
  return (
    <div>
      <nav className='w-full h-14 flex justify-between fixed top-0 items-center px-4 md:px-5 py-3 bg-slate-900'>
        <div className='flex items-center'>
          <svg className="text-white sm:ml-2 md:ml-3" stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.1" viewBox="0 0 32 32" height="3rem" width="3rem" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className='text-white font-bold ml-2 text-2xl'>Portfolio</p>
        </div>
        <ul className={`md:flex menu-container ${menuOpen ? 'flex flex-col absolute top-full bg-slate-950 bg-opacity-80 h-75 py-4 w-full' : 'hidden'}`}>
          <li><a className='text-white font-semibold ml-3 mx-2 hover:text-indigo-600 hover:border-2 hover:border-indigo-900 hover:py-2 hover:px-3 hover:rounded-2xl' href="/about">About</a></li>
